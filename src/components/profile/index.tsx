...
export default function Profile() {
    return (
        <>
            <div className="w-full flex flex-col items-center justify-center lg:fixed lg:left-4 lg:top-1/2 lg:-translate-y-1/2 lg:max-w-sm border border-neutral-600 rounded-3xl p-10">
                ...
                <div className="w-full flex justify-center items-center max-w-xs bg-intense-blue p-4 rounded-3xl mb-11">
                    <Image
                ...
                <button className="group px-8 py-2 bg-intense-blue rounded-full border-2 border-intense-blue hover:bg-transparent transition-all duration-500">
                    <a className="flex items-center text-xl uppercase group-hover:text-intense-blue transition-all duration-500" href="https://wa.me/5511980348798" target="_blank" rel="noopener noreferrer">
